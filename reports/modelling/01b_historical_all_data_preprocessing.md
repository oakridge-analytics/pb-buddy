...
# Preprocssing of Historical PinkBike Ads - All Ads
...
(
    ...
    .style
    .hide(axis="index")
    .set_caption("All Ads by Category - North America Scraped Data")
)
```
...
```python
top_n = 5
top_bike_categories = (df_sold_ads.category.value_counts().index[0:top_n].tolist())
(
    df_sold_ads
